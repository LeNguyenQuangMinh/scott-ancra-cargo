# Changelog
## 25.2.2021 (Halo - Version 1.0.1)
- Added Quick Edit Cart function.
- Added Hot Stock function.
- Added Compare Color function.
- Added Quick View and Wishlist on tablet/mobile.
- Added "New" label for product cards.
- Update Color Variant function to optimize page speed.
- Update Someone Purchased function to optimize page speed.
- Update code Mega Menu to optimize page speed.
- Update Theme Editor for Mega Menu and Newsletter Popup.
- Update code Product By Category on the homepage.
- Update source code according to AA standard.
- Change href to data-href for fancybox function to fix for WCAG 2.0 Level AA.
- Fixed AToZ brands layout.
- Fixed Total Price for Product Bundle function.
- Fixed Product Detail page not show Image Comming Soon if you don't upload image for the product.
- Fixed case when default option is out of stock add to cart button does not populate for in stock options.
- Fixed input placeholder color contrast according to AA standard. 
